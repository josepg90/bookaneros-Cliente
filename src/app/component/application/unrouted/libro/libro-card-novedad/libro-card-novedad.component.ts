...
@Component({
  selector: 'app-libro-card-novedad',
  templateUrl: './libro-card-novedad.component.html',
  styleUrls: ['./libro-card-novedad.component.scss']
})
export class LibroCardNovedadComponent implements OnInit {
  ...
  getPage = () => {
    ...
    this.oLibroService.getNovedad(this.nPageSize, this.nPage, this.strFilter, this.strSortField, this.strSortDirection, this.id_tipolibro).subscribe((oPage: IPageLibro) => {
      if (this.strFilter) {
